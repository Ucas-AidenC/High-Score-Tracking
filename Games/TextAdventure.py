...
def GameOver(boss, saved_inventory):
...
def Fight(boss):
    ...
    while not fight_finished:
        ...
        # Victory Sequence
            ...
            player_stats['score'] += round(boss['score'] * (10/turn))
            input(f'User gained +{round(boss['score'] * (10/turn))} score')
